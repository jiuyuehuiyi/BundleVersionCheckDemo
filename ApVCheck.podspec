#
#  Be sure to run `pod spec lint ApVCheck.podspec' to ensure this is a
...
A version check api for App has submited to appstore. have fun!
  ...
  # Or just: spec.author    = "踏歌长行"
  # spec.authors            = { "踏歌长行" => "1031484446@qq.com" }
  # spec.social_media_url   = "https://twitter.com/踏歌长行"
